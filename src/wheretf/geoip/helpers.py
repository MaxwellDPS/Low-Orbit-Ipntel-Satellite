...
class Region(object):
    ...
    def __init__(self, _region: geoip2.records.Subdivision, **kwargs) -> None:
        self.name: str = _region.name
        self.iso_code: int = _region.iso_code
        self.confidence: int = _region.confidence
        self.names: list[str] = _region.name
